...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-head-line">植物浏览</h1>
                    <h1 class="page-subhead-line">下面是所有植物信息 </h1>
            ...
            <div >
                <!--    Hover Rows  -->
                <form action="Bodele" method="post" name="del"  >
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <%
                                        ...
                                        Query q=hsession.createQuery("from BotanyEntity ");

                                        List<BotanyEntity> s=q.list();
                                    ...
                                    <tr id="tr_<%=i+1 %>">
                                        ...
                                        <td><%=s.get(i).getContext()%></td>


                                        <td><button onclick="location.href='bochange.jsp?id=<%=s.get(i).getId()%>'" type="button" class="btn btn-warning">修改</button></td>
                                    </tr>
                ...
                <button onclick="location.href='boadd.jsp'" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i>新建</button>
                <!-- End  Hover Rows  -->
            </div>
