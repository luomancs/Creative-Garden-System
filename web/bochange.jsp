        ...
        <div id="page-inner">
            ...
            <div >
                ...
                <div class="panel panel-default">
                    ...
                    <form action="Bochange" method="post" name="sub" onsubmit="return error(this)">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12" style="left:100px;width:500px">
                                    <div class="panel panel-info">
                                        ...
                                        <%
                                            ...
                                            Query q=hsession.createQuery("from BotanyEntity b where b.id=?");
                                            q.setInteger(0, id);
                                        ...
                                        <div class="panel-body" >
                                            <div class="form-group" >
                                                <label>景点id</label>
                                                <input name="sid" class="form-control" type="text" value="<%=s.get(0).getSid()%>" disabled="" >
                                            </div>
                                            <div class="form-group" >
                                                <label>植物id</label>
