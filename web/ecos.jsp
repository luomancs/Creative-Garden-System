        ...
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-subhead-line">下面是每日生态环境信息 </h1>
            ...
            <div >
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <%
                                        ...
                                        Query q=hsession.createQuery("from EcosEntity ");
                                    ...
                                    <tr id="tr_<%=i+1 %>">
                                        <td><input type="checkbox" name="check" id="check" value="<%=s.get(i).getDay()%>"></input></td>
                                        ...
                                        <td><button onclick="location.href='ecoschange.jsp?day=<%=s.get(i).getDay()%>'" type="button" class="btn btn-warning">修改</button></td>
                                    </tr>
                ...
                <button onclick="location.href='ecosadd.jsp'" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i>新建</button>
                <!-- End  Hover Rows  -->
            </div>
