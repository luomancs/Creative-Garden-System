        ...
        <div id="page-inner">
            ...
            <div >
                ...
                <div class="panel panel-default">
                    ...
                    <form action="Ecoschange" method="post" name="sub" onsubmit="return error(this)">
                            ...
                            <div class="panel-body">
                                <div class="col-md-6 col-sm-6 col-xs-12" style="left:100px;width:500px">
                                    <div class="panel panel-info">
                                        ...
                                        <%
                                            String dstr=request.getParameter("day");
                                            System.out.println(dstr);
                                            SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd");//小写的mm表示的是分钟

                                            java.util.Date day=sdf.parse(dstr);

                                            Configuration cfg = new  Configuration().configure();
                                            SessionFactory sf = cfg.buildSessionFactory();
                                            Session hsession = sf.openSession();
                                            Transaction ts = hsession.beginTransaction();
                                            Query q=hsession.createQuery("from EcosEntity b where b.day=?");
                                            q.setDate(0, day);
                                        ...
                                        <div class="panel-body" >
                                            <div class="form-group" >
                                                <label> 日期</label>
                                                <input name="day" id="d244" type="text" name="day" class="Wdate" style="height:30px;" value="<%=s.get(0).getDay()%>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',vel:'d244_2'})"/>

                                            </div>
                                            <div class="form-group" >
                                                <label>温度</label>
                                                <input name="tem" class="form-control" type="text" value="<%=s.get(0).getTemperature()%>">
                                            </div>
                                            <div class="form-group">
                                                <label>湿度</label>
                                                <input name="hum" class="form-control" type="text" value="<%=s.get(0).getHumidity()%>">
                                            </div>
                                            <div class="form-group">
                                                <label>PM2.5</label>
                                                <input name="pm" class="form-control" type="text" value="<%=s.get(0).getPm()%>">
                                            </div>
                                            <div class="form-group">
                                                <label>风度</label>
                                                <input name="wind" class="form-control" type="text" value="<%=s.get(0).getWind()%>">
                                            </div>
                                            <div class="form-group">
                                                <label>穿衣推荐</label>
                                                <input name="clo" class="form-control" type="text" value="<%=s.get(0).getClothes()%>">
                                            </div>
